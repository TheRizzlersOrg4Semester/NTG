...
const GATES = [
  ...
  { id: "UK_ORIGIN_LICHFIELD", gate_id: "UK_ORIGIN_LICHFIELD", name: "Lichfield / Manchester Origin", tier: 1, type: "Origin", gate_type: "Origin", x: 40, y: 520, lon: -1.82, lat: 52.68, gate_owner: "NTG Road UK / Carrier", source_label: "Shipment created / loaded" },
  { id: "FOLKESTONE_CHECKIN", gate_id: "FOLKESTONE_CHECKIN", name: "Folkestone Check-in", tier: 1, type: "Tunnel terminal", gate_type: "Tunnel terminal", x: 80, y: 640, lon: 1.16, lat: 51.10, gate_owner: "LeShuttle Freight", source_label: "Partner event feed" },
  { id: "DOVER_CHECKIN", gate_id: "DOVER_CHECKIN", name: "Dover Check-in", tier: 1, type: "Ferry terminal", gate_type: "Ferry terminal", x: 95, y: 620, lon: 1.31, lat: 51.13, gate_owner: "DFDS / Port of Dover", source_label: "Partner event feed" },
  { id: "CALAIS_EXIT", gate_id: "CALAIS_EXIT", name: "Calais Exit", tier: 1, type: "Ferry terminal", gate_type: "Ferry terminal", x: 145, y: 625, lon: 1.86, lat: 50.95, gate_owner: "DFDS Calais", source_label: "Partner event feed" },
  { id: "COQUELLES_EXIT", gate_id: "COQUELLES_EXIT", name: "Coquelles Exit", tier: 1, type: "Tunnel terminal", gate_type: "Tunnel terminal", x: 150, y: 612, lon: 1.81, lat: 50.93, gate_owner: "LeShuttle Freight", source_label: "Partner event feed" },
  { id: "HAMBURG_CORRIDOR", gate_id: "HAMBURG_CORRIDOR", name: "Hamburg Corridor", tier: 1, type: "Corridor milestone", gate_type: "Corridor milestone", x: 520, y: 600, lon: 9.99, lat: 53.55, gate_owner: "Corridor intelligence", source_label: "Simulated corridor event" },
  { id: "PUTTGARDEN_CHECKIN", gate_id: "PUTTGARDEN_CHECKIN", name: "Puttgarden Check-in", tier: 1, type: "Ferry terminal", gate_type: "Ferry terminal", x: 675, y: 632, lon: 11.22, lat: 54.50, gate_owner: "Scandlines Freight", source_label: "Partner event feed" },
  { id: "RODBY_EXIT", gate_id: "RODBY_EXIT", name: "Rødby Exit", tier: 1, type: "Ferry terminal", gate_type: "Ferry terminal", x: 690, y: 600, lon: 11.35, lat: 54.66, gate_owner: "Scandlines Freight", source_label: "Partner event feed" },
  { id: "CPH_TERMINAL_ARRIVAL", gate_id: "CPH_TERMINAL_ARRIVAL", name: "CPH Terminal Arrival", tier: 1, type: "Customer terminal", gate_type: "Customer terminal", x: 780, y: 425, lon: 12.47, lat: 55.66, gate_owner: "NTG Partner Terminal", source_label: "Terminal milestone feed" },
  { id: "KOGE_TERMINAL_ARRIVAL", gate_id: "KOGE_TERMINAL_ARRIVAL", name: "Køge Terminal Arrival", tier: 1, type: "Destination terminal", gate_type: "Destination terminal", x: 770, y: 475, lon: 12.18, lat: 55.46, gate_owner: "NTG / Customer site", source_label: "Terminal arrival event" },
...
const CORRIDORS = [
  { id: "UKDK", name: "UK-DK Pulse Corridor", color: "ember", gates: ["UK_ORIGIN_LICHFIELD", "FOLKESTONE_CHECKIN", "COQUELLES_EXIT", "HAMBURG_CORRIDOR", "PUTTGARDEN_CHECKIN", "RODBY_EXIT", "KOGE_TERMINAL_ARRIVAL"] },
...
const SHIPMENTS = [
  {
    ...
    origin: "Lichfield / Manchester, UK",
    destination: "Køge, DK",
    ...
    cargo_profile: "Retail distribution",
    ...
    route: ["UK_ORIGIN_LICHFIELD", "FOLKESTONE_CHECKIN", "COQUELLES_EXIT", "HAMBURG_CORRIDOR", "PUTTGARDEN_CHECKIN", "RODBY_EXIT", "KOGE_TERMINAL_ARRIVAL"],
    ...
    events: [
      {
        event_id: "evt_ukdk_000",
        gate: "UK_ORIGIN_LICHFIELD",
        gate_id: "UK_ORIGIN_LICHFIELD",
        timestamp: new Date(NOW_REF - 760 * M).toISOString(),
        confidence: 0.99,
        confidence_score: 0.99,
        status: "confirmed",
        reason: "Gate matches expected route and equipment.",
      ...
      },
      {
        ...
        gate: "HAMBURG_CORRIDOR",
        gate_id: "HAMBURG_CORRIDOR",
        timestamp: new Date(NOW_REF - 154 * M).toISOString(),
        confidence: 0.93,
  ...
  },
  {
    ...
    cargo_profile: "Temperature-controlled",
    eta_impact_minutes: 88,
    eta: NOW_REF - 88 * M,
    status: "exception",
    progress: 0.62,
    route: ["RBY", "CPH"],
...
const GATE_VOLUME_24H = {
  UK_ORIGIN_LICHFIELD: 18, HAMBURG_CORRIDOR: 96, KOGE_TERMINAL_ARRIVAL: 42,
